package com.viettel.mocha.rmlivestream.socket.stomp;
...
import com.viettel.mocha.rmlivestream.socket.stomp.provider.OkHttpConnectionProvider;
import com.viettel.mocha.rmlivestream.socket.stomp.provider.WebSocketsConnectionProvider;
...
public class Stomp {
    ...
    public static StompClient over(@NonNull ConnectionProvider connectionProvider, String uri, @Nullable Map<String, String> connectHttpHeaders, @Nullable OkHttpClient okHttpClient) {
        ...
        OkHttpClient okHttp = HttpsTrustManager.getUnsafeOkHttpClient();
    ...
    private static StompClient createStompClient(com.viettel.mocha.rmlivestream.socket.stomp.provider.ConnectionProvider connectionProvider) {
