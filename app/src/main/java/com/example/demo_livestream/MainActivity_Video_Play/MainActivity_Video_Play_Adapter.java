...
public class MainActivity_Video_Play_Adapter extends RecyclerView.Adapter<MainActivity_Video_Play_Adapter.ViewHolder> {
    private List<MainActivity_Video_Play_Model> itemList;

    public MainActivity_Video_Play_Adapter(List<MainActivity_Video_Play_Model> itemList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        MainActivity_Video_Play_Model item = itemList.get(position);
